...
export const RecipeFindManySelectSchema: z.ZodType<Prisma.RecipeSelect> = z.object({
...
export const RecipeFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    cookTime: z.boolean().optional(),
    description: z.boolean().optional(),
    directions: z.boolean().optional(),
...
export const RecipeFindManySchema: z.ZodType<Prisma.RecipeFindManyArgs> = z.object({ select: RecipeFindManySelectSchema.optional(), include: z.lazy(() => RecipeIncludeObjectSchema.optional()), orderBy: z.union([RecipeOrderByWithRelationInputObjectSchema, RecipeOrderByWithRelationInputObjectSchema.array()]).optional(), where: RecipeWhereInputObjectSchema.optional(), cursor: RecipeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecipeScalarFieldEnumSchema, RecipeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RecipeFindManyArgs>;

export const RecipeFindManyZodSchema = z.object({ select: RecipeFindManySelectSchema.optional(), include: z.lazy(() => RecipeIncludeObjectSchema.optional()), orderBy: z.union([RecipeOrderByWithRelationInputObjectSchema, RecipeOrderByWithRelationInputObjectSchema.array()]).optional(), where: RecipeWhereInputObjectSchema.optional(), cursor: RecipeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecipeScalarFieldEnumSchema, RecipeScalarFieldEnumSchema.array()]).optional() }).strict();
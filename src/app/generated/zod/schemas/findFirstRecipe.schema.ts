...
export const RecipeFindFirstSelectSchema: z.ZodType<Prisma.RecipeSelect> = z.object({
...
export const RecipeFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    cookTime: z.boolean().optional(),
    description: z.boolean().optional(),
    directions: z.boolean().optional(),
...
export const RecipeFindFirstSchema: z.ZodType<Prisma.RecipeFindFirstArgs> = z.object({ select: RecipeFindFirstSelectSchema.optional(), include: z.lazy(() => RecipeIncludeObjectSchema.optional()), orderBy: z.union([RecipeOrderByWithRelationInputObjectSchema, RecipeOrderByWithRelationInputObjectSchema.array()]).optional(), where: RecipeWhereInputObjectSchema.optional(), cursor: RecipeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecipeScalarFieldEnumSchema, RecipeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RecipeFindFirstArgs>;

export const RecipeFindFirstZodSchema = z.object({ select: RecipeFindFirstSelectSchema.optional(), include: z.lazy(() => RecipeIncludeObjectSchema.optional()), orderBy: z.union([RecipeOrderByWithRelationInputObjectSchema, RecipeOrderByWithRelationInputObjectSchema.array()]).optional(), where: RecipeWhereInputObjectSchema.optional(), cursor: RecipeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecipeScalarFieldEnumSchema, RecipeScalarFieldEnumSchema.array()]).optional() }).strict();